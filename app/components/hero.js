...
const Hero = () => {
    return (
        <div className="mt-6 rounded-md  min-h-[2000px] flex lg:flex-row flex-col w-full max-w-[1024px] text-white">
            <div className="h-[400px] justify-between items-center flex flex-col bg-gradient-to-b from-myPink to-myPurple w-[35%] rounded-tl-md rounded-bl-md p-6 pt-6 gap-0">
                ...
                <span className="border-t border-white w-full pt-3 font-medium text-center">
                    Find out more!
                </span>
            </div>
